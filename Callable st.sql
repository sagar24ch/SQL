...
## delimiter ;
delimiter ##
create procedure findGrade2(IN mysid int)
begin
declare mm1 int;
declare mm2 int;
declare mm3 int;
...
delimiter ##
create procedure findMyGrade1 (IN mysid int,OUT mytotal int,OUT myaverage double,OUT mystatus char,OUT mygrade char)
begin
declare mm1 int;
declare mm2 int;
declare mm3 int;
...
select * from jlcstudents;
delimiter ##
create procedure findMyGrade2 (IN mysid int,OUT mytotal int,OUT myaverage double,OUT mystatus char,OUT mygrade char)
begin
declare mm1 int;
declare mm2 int;
declare mm3 int;
...
select * from jlcstudents;
delimiter ##
create procedure findMyGrade3(IN mysid int,OUT mytotal int,OUT myaverage double,OUT mystatus char,OUT mygrade char)
begin
declare mm1 int;
declare mm2 int;
declare mm3 int;
